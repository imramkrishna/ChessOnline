...
const Game = () => {
    ...
    return (
        <div className="min-h-screen bg-[#121212] relative overflow-x-hidden overflow-y-auto">
            {
                hasResult && (
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-[#BB86FC]/5 to-[#03DAC6]/5 rounded-full blur-3xl"></div>
            ...
            <div className="relative z-10 p-4 sm:p-6 lg:p-8 w-full">
                <div className="max-w-7xl mx-auto w-full">
                    ...
                    <div className="text-center mb-6 lg:mb-8 px-2">
                        ...
                        <p className="text-white/70 text-lg">Live Chess Battle Arena</p>
                    </div>
                    ...
                    <div className="flex flex-col lg:grid lg:grid-cols-4 xl:grid-cols-5 gap-4 lg:gap-6 w-full">
                        ...
                        <div className="lg:col-span-3 xl:col-span-4 order-1 w-full">
                            <div className="bg-[#1E1E1E] backdrop-blur-2xl rounded-2xl lg:rounded-3xl p-4 lg:p-8 border border-[#BB86FC]/30 shadow-2xl hover:bg-[#252525] transition-all duration-500 w-full overflow-hidden">
                                <div className="text-center mb-4 lg:mb-8">
                                    <h3 className="text-2xl lg:text-4xl font-bold mb-2 lg:mb-3 bg-gradient-to-r from-white to-[#BB86FC] bg-clip-text text-transparent">
                                        Game Board
                                    </h3>
                                ...
                                <div className="flex justify-center">
                                    <div className="flex items-center space-x-4 lg:space-x-8 bg-[#121212] backdrop-blur-lg rounded-xl px-4 lg:px-8 py-3 lg:py-4 text-sm lg:text-lg border border-[#BB86FC]/30 shadow-lg">
                                        <div className="flex items-center space-x-2">
                                            <div className={`w-3 h-3 lg:w-4 lg:h-4 rounded-full shadow-lg ${gameStarted
                                                ? 'bg-[#03DAC6] animate-pulse'
                                                : 'bg-[#BB86FC] animate-pulse'
                                                }`}></div>
                                            ...
                                            {gameStarted && (
                                                <span className={`text-xs px-2 py-1 rounded-full ${(playerColor === 'white' && currentTurn === 'w') || (playerColor === 'black' && currentTurn === 'b')
                                                    ? 'bg-[#03DAC6]/20 text-[#03DAC6] border border-[#03DAC6]/30'
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <span className="text-white/70 font-medium">Move:</span>
                                            <span className="font-bold text-[#03DAC6] text-xl">
                                                {moveCount}
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <div className="lg:col-span-1 xl:col-span-1 space-y-3 lg:space-y-4 order-2 w-full overflow-hidden">
                            ...
                            <div className="bg-[#1E1E1E] backdrop-blur-2xl rounded-2xl lg:rounded-3xl p-4 lg:p-6 border border-[#BB86FC]/30 shadow-2xl hover:bg-[#252525] transition-all duration-500 overflow-hidden">
                                <h2 className="text-xl lg:text-2xl font-bold text-white mb-4 flex items-center">
                                    ...
                                    <span className="hidden sm:inline bg-gradient-to-r from-white to-[#BB86FC] bg-clip-text text-transparent">Game Status</span>
                                    <span className="sm:hidden bg-gradient-to-r from-white to-[#BB86FC] bg-clip-text text-transparent">Status</span>
                                </h2>

                                <div className="space-y-4">
                                    {/* Status Indicator - Enhanced */}
                                    <div className="flex items-center space-x-3 p-3 lg:p-4 bg-[#121212] rounded-xl border border-[#BB86FC]/30 backdrop-blur-sm">
                                        <div className={`w-4 h-4 lg:w-5 lg:h-5 rounded-full shadow-lg ${gameStatus === 'playing' ? 'bg-[#03DAC6] animate-pulse' :
                                            gameStatus === 'waiting' ? 'bg-[#BB86FC] animate-pulse' : 'bg-[#BB86FC]'
                                            }`}></div>
                                    ...
                                    <div className="bg-[#121212] rounded-xl p-3 lg:p-4 space-y-3 border border-[#BB86FC]/30 overflow-hidden">
                                        <div className="flex justify-between items-center min-w-0">
                                            <span className="text-white/70 flex items-center text-sm lg:text-base font-medium flex-shrink-0">
                                            ...
                                            <div className="flex items-center space-x-2 flex-shrink-0">
                                                ...
                                                <div className={`w-2 h-2 rounded-full flex-shrink-0 ${gameStarted ? 'bg-[#03DAC6]' : 'bg-[#BB86FC] animate-pulse'
                                                    }`}></div>
                                            </div>
                                        </div>
                                        <div className="flex justify-between items-center min-w-0">
                                            ...
                                            <div className="flex items-center space-x-2 flex-shrink-0">
                                                {gameStarted ? (
                                                    <>
                                                        ...
                                                        <div className="w-2 h-2 rounded-full bg-[#03DAC6] flex-shrink-0"></div>
                                                    </>
                                                ) : (
                                                    <span className="text-xs text-white/50 px-2 py-1 bg-[#121212] rounded-md whitespace-nowrap border border-[#BB86FC]/30">
                                                        Searching...
                                                    </span>
                                                )}
                                            </div>
                            ...
                            <div className="bg-[#1E1E1E] backdrop-blur-xl rounded-xl lg:rounded-2xl p-3 lg:p-4 border border-[#BB86FC]/30 shadow-2xl hover:bg-[#252525] transition-all duration-300">
                                    ...
                                    {gameStarted ? (
                                        <>
                                            <button
                                                ...
                                                className="group w-full bg-[#121212] hover:bg-[#1E1E1E] text-white font-semibold py-2 lg:py-3 px-3 lg:px-4 rounded-lg lg:rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-xl border border-[#BB86FC]/30 relative overflow-hidden"
                                            >
                                            ...
                                            <div className="grid grid-cols-2 gap-2 lg:gap-3">
                                                <button
                                                onClick={handleDraw}
                                                 className="group bg-[#03DAC6] hover:bg-[#02C3B3] text-[#121212] font-semibold py-2 px-2 lg:px-3 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl relative overflow-hidden">
                                                ...
                                                <button className="group bg-[#BB86FC] hover:bg-[#A370E3] text-[#121212] font-semibold py-2 px-2 lg:px-3 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl relative overflow-hidden"
                                                    onClick={() => handleResign()}
                                                >
                                                    <div className="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                                    <div className="relative flex flex-col items-center justify-center space-y-1">
                                        ...
                                        <div className="text-center py-4 lg:py-6">
                                            <div className="animate-spin w-8 h-8 lg:w-10 lg:h-10 border-4 border-[#BB86FC]/30 border-t-[#BB86FC] rounded-full mx-auto mb-3"></div>
                                            <p className="text-[#BB86FC] font-medium text-sm lg:text-base">
                            ...
                            <div className="bg-[#1E1E1E] backdrop-blur-xl rounded-xl lg:rounded-2xl p-3 lg:p-4 border border-[#BB86FC]/30 shadow-2xl hover:bg-[#252525] transition-all duration-300">
                                ...
                                <div className="space-y-2 lg:space-y-3">
                                    <div className="flex justify-between items-center p-3 bg-[#121212] rounded-xl border border-[#BB86FC]/30">
                                        <span className="text-white/70 flex items-center">
                                            <span className="text-sm lg:text-lg mr-1 lg:mr-2">⏱️</span>
                                            <span className="hidden sm:inline">Game Time</span>
                                            <span className="sm:hidden">Time</span>
                                        </span>
                                        <span className="text-lg lg:text-2xl font-mono text-[#03DAC6] font-bold">{formatTime(gameTime)}</span>
                                    </div>
                                </div>
                            </div>

                            {/* Move History - Compact */}
                            <div className="bg-[#1E1E1E] backdrop-blur-xl rounded-xl lg:rounded-2xl p-3 lg:p-4 border border-[#BB86FC]/30 shadow-2xl hover:bg-[#252525] transition-all duration-300 hidden lg:block">
                                <h3 className="text-lg lg:text-xl font-bold text-white mb-3 flex items-center">
                                    <span className="text-lg lg:text-xl mr-2">📋</span>
                                    History
                                </h3>

                                <div className="max-h-24 lg:max-h-32 overflow-y-auto text-sm text-white/70 bg-[#121212] rounded-lg p-2 lg:p-3">
                                        ...
                                        {moveHistory.length === 0 ? (
                                            ...
                                            moveHistory.map((move, index) => (
                                                <div key={index} className="flex justify-between items-center">
                                                    ...
                                                    <span className="text-xs text-white/50 font-mono">{new Date(move.moveTime).toLocaleTimeString()}</span>
                                                </div>
                                            ))
                                        }
                                    </div>
                    ...
                    <div className="mt-6 lg:mt-8 text-center">
                        <button
                            onClick={() => navigate("/")}
                            className="group bg-[#1E1E1E] hover:bg-[#252525] text-white px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-xl border border-[#BB86FC]/30"
                        >
                            <span className="flex items-center justify-center space-x-2">
                                <span>←</span>
