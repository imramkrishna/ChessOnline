            ...
            <div className="relative z-10 p-2 sm:p-4 lg:p-8 w-full">
                <div className="max-w-7xl mx-auto w-full">
                    ...
                    <div className="text-center mb-6 lg:mb-8 px-2">
                        ...
                        <p className="text-[#888] text-sm">Private Room Battle</p>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 w-full items-start">
                        ...
                        <div className="w-full lg:flex-1 lg:min-w-0 order-1">
                            <div className="bg-white/80 backdrop-blur-sm rounded-2xl lg:rounded-3xl p-3 sm:p-4 lg:p-6 border border-black/[0.06] shadow-[0_4px_30px_rgba(0,0,0,0.06)] w-full overflow-hidden">
