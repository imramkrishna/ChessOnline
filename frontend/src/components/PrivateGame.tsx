                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center space-x-3 p-3 lg:p-4 bg-[#121212] rounded-xl border border-[#BB86FC]/30 backdrop-blur-sm">
                                        <div className={`w-4 h-4 lg:w-5 lg:h-5 rounded-full shadow-lg ${gameStatus === 'playing' ? 'bg-[#03DAC6] animate-pulse' :
                                            gameStatus === 'waiting' ? 'bg-[#BB86FC] animate-pulse' : 'bg-gradient-to-r from-red-400 to-red-600'
                                            }`}></div>
                                        ...
                                        <div className="flex justify-between items-center min-w-0">
                                            ...
                                            <div className="flex items-center space-x-2 flex-shrink-0">
                                                {gameStarted ? (
                                                    ...
                                                    <span className="text-xs text-white/50 px-2 py-1 bg-[#121212] border border-[#BB86FC]/30 rounded-md whitespace-nowrap">
                                                        Searching...
                                                    </span>
                                                )}
                                            </div>
                                    ...
                                    {gameStarted ? (
                                        <>
                                            <button
                                                ...
                                                className="group w-full bg-[#121212] hover:bg-[#1E1E1E] text-white border border-[#BB86FC]/30 font-semibold py-2 lg:py-3 px-3 lg:px-4 rounded-lg lg:rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-xl relative overflow-hidden">
